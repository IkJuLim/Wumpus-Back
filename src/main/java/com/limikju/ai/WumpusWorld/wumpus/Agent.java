...
public class Agent {
	private World w;
	int wumpus = 0, pa = 0, pb = 0, minvalue = 100, t = 1, minscore = 100, k1, k = 1, fp = 0;
	int path = 0;
	int[][] map = new int[4][4];
	int[] b = new int[10];
	int pd = 0;
	...
	public void doAction() {
		...
		if (path == 1) {
			...
			if (w.hasBreeze(cX, cY) && w.hasStench(cX, cY)) {
				...
				int[] a = new int[50];
				if (map[transformX][transformY] != -4 && map[transformX][transformY] != -5 && map[transformX][transformY] != -7 && map[transformX][transformY] != -2)
					map[transformX][transformY] = 1;

				if (transformX - 1 >= 0 && map[transformX - 1][transformY] != -4 && map[transformX - 1][transformY] != -5 && map[transformX - 1][transformY] != -7)
					map[transformX - 1][transformY] = 1;
				if (transformY + 1 <= 3 && map[transformX][transformY + 1] != -4 && map[transformX][transformY + 1] != -5 && map[transformX][transformY + 1] != -7)
					map[transformX][transformY + 1] = 1;
				if (transformX + 1 <= 3 && map[transformX + 1][transformY] != -4 && map[transformX + 1][transformY] != -5 && map[transformX + 1][transformY] != -7)
					map[transformX + 1][transformY] = 1;
				if (transformY - 1 >= 0 && map[transformX][transformY - 1] != -4 && map[transformX][transformY - 1] != -5 && map[transformX][transformY - 1] != -7)
					map[transformX][transformY - 1] = 1;
				...
				for (int i = 0; i < 4; i++) {
					for (int j = 0; j < 4; j++) {
						if (map[i][j] == -4) {
							if ((i - 1 <= 3 && i - 1 >= 0))
								if (map[i - 1][j] != 1 && (i - 1 <= 3 && i - 1 >= 0) && map[i - 1][j] != 3 && map[i - 1][j] != -4 && map[i - 1][j] != -3 && map[i - 1][j] != -5) {
									count++;
									x1 = i - 1;
									y1 = j;
								}
							if (i + 1 <= 3 && i + 1 >= 0)
								if (map[i + 1][j] != 1 && (i + 1 <= 3 && i + 1 >= 0) && map[i + 1][j] != 3 && map[i + 1][j] != -3 && map[i + 1][j] != -4 && map[i + 1][j] != -5) {
									count++;
							...
							if (j + 1 <= 3 && j + 1 >= 0)
								if (map[i][j + 1] != 1 && (j + 1 <= 3 && j + 1 >= 0) && map[i][j + 1] != 3 && map[i][j + 1] != -4 && map[i][j + 1] != -3 && map[i][j + 1] != -5) {
									count++;
							...
							if (j - 1 >= 0 && j - 1 >= 0)
								if (map[i][j - 1] != 1 && (j - 1 >= 0 && j - 1 >= 0) && map[i][j - 1] != 3 && map[i][j - 1] != -4 && map[i][j - 1] != -3 && map[i][j - 1] != -5) {
									count++;
									x1 = i;
									y1 = j - 1;
								}
				...
				for (int i = 0; i < 4; i++) {
					for (int j = 0; j < 4; j++) {
						if (map[i][j] == -5) {
							if (i - 1 <= 3 && i - 1 >= 0)
								if (map[i - 1][j] != 1 && (i - 1 <= 3 && i - 1 >= 0) && map[i - 1][j] % 2 != 0 && map[i - 1][j] != -4) {
									count++;
									x1 = i - 1;
									y1 = j;
								}
							...
							if (j + 1 <= 3 && j + 1 >= 0)
								if (map[i][j + 1] != 1 && (j + 1 <= 3 && j + 1 >= 0) && map[i][j + 1] % 2 != 0 && map[i][j + 1] != -4) {
									count++;
									x1 = i;
									y1 = j + 1;
								}
